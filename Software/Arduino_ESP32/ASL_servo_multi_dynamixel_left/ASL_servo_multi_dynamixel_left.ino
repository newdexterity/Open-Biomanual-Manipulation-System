...
void servo_cb( const std_msgs::Float32MultiArray& cmd_msg) {
  ...
  wristFlex.write(map(cmd_msg.data[0], -90, 10, 10, 165));
  wristPiv.write(map(cmd_msg.data[1], -25, 65, 20, 160));
...
ros::Subscriber<std_msgs::Float32MultiArray> sub("leftservo", servo_cb);
